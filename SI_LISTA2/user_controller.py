...
HEURISTIC_FN_ARG_HELP_TEXT = f"Choose heuristic function of your enemy:\n \
        1 - {HEURISTIC_FN_CONVERTER[1].__name__}, \
        2 - {HEURISTIC_FN_CONVERTER[2].__name__}, \
        3 - {HEURISTIC_FN_CONVERTER[3].__name__}, \
        4 - {HEURISTIC_FN_CONVERTER[4].__name__}, \
        5 - {HEURISTIC_FN_CONVERTER[5].__name__}, \
        6 - {HEURISTIC_FN_CONVERTER[6].__name__}"
...
def start_the_game(heuristic_fn, distance_fn):
    ...
    while(True):
        ...
        if moves_counter % 2 == 1: # user move
            ...
            ai_dtree = DTree(game, BLACK_PLAYER_CELL, heuristic_fn, distance_fn)
